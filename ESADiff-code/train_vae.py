...
def main(args):
    ...
    experiment = wandb.init(project='AutoEncoder', resume='allow', entity='1143284345')
            ...
            while self.step < self.train_num_steps:
                ...
                for ga_ind in range(self.gradient_accumulate_every):
                    ...
                    with self.accelerator.autocast():
                        ...
                        current_loss = total_loss  # 当前步骤的总损失
                ...
                if accelerator.is_main_process:
                    ...
                    if self.step != 0 and self.best_loss>current_loss:
